...
#define SCH_IS_WECHAT_ENABLED true //libWeCharSDK.a, WXApi.h, WXApiObject.h,SystemConfiguration.framework,libz.dylib,libsqlite3.0.dylib
...
#define SCH_WECHAT_APP_ID @"wx6917c7e44bd2212c"
